...
<?php if ( $has_methods ) : ?>
	<h3 class="bg-platinum d-flex justify-content-between account-tittle font-lg">All Payment Methods
	
	<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<a class="button text-white br-50 font-md Montserrat fw-400" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
<?php endif; ?>
	</h3>
